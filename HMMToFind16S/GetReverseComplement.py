...
# Description: A simple program that takes a nucleotide FASTA file and returns the exact same FASTA
#              file with a reverse complemented sequence. Also works with multi-sequence FASTA files.
#
